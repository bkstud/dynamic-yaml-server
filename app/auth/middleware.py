"""Auth middleware with custom default error handling.

This is very similar to fastapi_contrib.auth.middlewares.
It does not contain empty 'fields' array and gives exception message as detail.
"""
...
from app.common.response import UJSONResponse
