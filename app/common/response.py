"""Improved response taken from fastapi_contrib.common

For details see class docs. It is copied without modification not to include
extra dependency for such small class."""
